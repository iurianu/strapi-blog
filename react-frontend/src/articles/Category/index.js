            ...
            return (
              <main className="d-flex mx-0">
                ...
                <Helmet>
                  ...
                  <title>iurianu about {categories.data[0].attributes.name}</title>           
                  <link rel="stylesheet" href="./../lib/styles/blog.css" />
                </Helmet>

                <h1 itemProp="name" className="col-sm-6">iurianu about <br />
                  <span itemProp="about">{categories.data[0].attributes.name}</span>
                </h1>

                <blockquote id="category-description" className="p-3 col-sm-6 d-flex align-items-center" itemProp="description">
                  <ReactMarkdown children={categories.data[0].attributes.description} rehypePlugins={[rehypeRaw]} />
                </blockquote>
